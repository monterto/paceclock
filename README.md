...
Features:
  ...
  - Lap/Set counter that tracks times and splits
  - Optional rest timer
...
Usage:
  - Tap the clock face to start the time
  ...
  - Tap Reset to refresh the clock and start a new session

Installation:
  - Open https://monterto.github.io/paceclock/ in your browser
